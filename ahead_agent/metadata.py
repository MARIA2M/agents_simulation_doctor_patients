...
def build_metadata(
    ...
    return RunMetadata(
        ...
        # Copied whole, so what is stored is what will be sent (§12).
...
def _gpu_count() -> Optional[int]:
    # Ask SLURM first: on a login node nvidia-smi lists the machine's GPUs,
    # not the ones this job was given (§6.3).
